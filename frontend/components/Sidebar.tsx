...
export default function Sidebar({ activeMenu }: SidebarProps) {
    return (
        <div className="w-32 bg-white border-r flex flex-col items-center py-6" style={{ padding: '20px', position: 'fixed', top: '60px', left: '0', height: '100%', overflowY: 'auto', zIndex: 10}}>
